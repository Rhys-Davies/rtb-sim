%% TRS Task API Functionality task
...
%%
%
% Weird behaviour is because of opmodes
% Probably is also responsible for the arm movement issue as well
% Modification of VREP.m to add an option to change the opmode temporarily 
% for the relevant calls is required. 
...
%
% A call using any other opmode disables streaming. Which is what is
% happening here. Also may be necessary to use opmode_oneshot on the arm
% joints and the wheel joints.
%
% Ideally, setters should use opmode_oneshot.
% Setting signals should use oneshot_wait
...
sim.startSim('mode','simx_opmode_oneshot');
